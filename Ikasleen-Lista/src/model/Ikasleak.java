...
public class Ikasleak {
    ...
    public Ikasleak(int zenbakia, String izena, String abizena1, String abizena2, String microsoftKontua) {
    ...
    public String toString() {
        return "Ikasleak" + zenbakia  + izena + abizena1 + abizena2 + microsoftKontua;
    }       
}
